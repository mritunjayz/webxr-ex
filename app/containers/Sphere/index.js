...
export function HomePage() {
    ...
    glbLoader.load(
      ...
      gltf => {
        ...
        const shadowGeo = new THREE.PlaneBufferGeometry(planeSize, planeSize);
          ...
          sphereMat.color.setHSL(0.3, 1, .75);
          sphereMesh = new THREE.Mesh(sphereGeo, sphereMat);
          sphereMesh.position.set(0, sphereRadius -1 , 0);
          ...
          sphereShadowBases = {base, sphereMesh, shadowMesh, y: sphereMesh.position.y};
  ...
  function placeObject() {
    ...
    if (reticle.visible) {
      ...
      model.position.set(pos.x, pos.y- 0.5, pos.z);
      sphereMesh.position.set(pos.x, pos.y, pos.z);
      shadowMesh.position.set(pos.x, pos.y- 0.5, pos.z);
